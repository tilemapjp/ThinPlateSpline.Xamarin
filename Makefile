...
thinplatespline.js: tps/thinplatespline.cpp js/pre.js js/post.js
	$(EMCC) $(CFLAGS) tps/thinplatespline.cpp --pre-js js/pre.js --post-js js/post.js -o js/thinplatespline.js -s EXPORTED_FUNCTIONS="['__ZN17VizGeorefSpline2DD2Ev','__ZN17VizGeorefSpline2DC2Ei','__ZN17VizGeorefSpline2D15get_object_sizeEv','__ZN17VizGeorefSpline2D9add_pointEddPKd','__ZN17VizGeorefSpline2D5solveEv','__ZN17VizGeorefSpline2D9get_pointEddPd','__ZN17VizGeorefSpline2D14serialize_sizeEv','__ZN17VizGeorefSpline2D9serializeEPc','__ZN17VizGeorefSpline2D11deserializeEPc']"
